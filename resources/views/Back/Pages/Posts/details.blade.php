                        ...
                        <div class=""><br>
                            ...
                            @if(Auth::user()->role->slug=='admin')
                                @if($detail->is_approved==0)
                                    @if($detail->is_resubmitted==0)
                                        <div class="pull-right form-group">
                                            <button type="button" data-toggle="modal" data-target="#myModal" class="btn btn-warning btn-sm">
                                                Request for Resubmission </button>
                                        </div>
                                    @endif
                                @endif
                                @if($detail->is_resubmitted==1)
                                    <div class="pull-right form-group">
                                        <button type="button" class="btn btn-warning btn-sm">
                                            Awaiting for Resubmission </button>
                                    </div>
                                @endif
                            @endif
                        <!-- Modal -->
                                ...
                                <div class="modal-dialog">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form action="{{route('post.resubmission')}}" method="post">
                                            ...
                                            <div class="modal-footer">
                                                <button type="submit" class="btn btn-default" >Request for Resubmission</button>
                                                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                            </div>
                                        </form>
                                    </div>
